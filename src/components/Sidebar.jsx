...
function sidebar() {
    ...
    <aside id="sidebar-right">
        <section id="last-news" className="c-container {}">
            ...
            <SidebarItem sendDataToParent={handleDataFromChild} id='4' className={activeItem == 4 && location.pathname.includes('labs') ? 'active-side-tab' : ''} lab_link='/labs/4' lab_title="Лабораторная работа №3" lab_desc = "Маршруты, useState/Effect, Redux"/>
        </section>
    </aside>
    )
}
